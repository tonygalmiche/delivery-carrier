...
class StockQuantPackage(models.Model):
    ...
    def _chronopost_manage_options(self, picking, payload):
        # Set default values
    ...
    def _chronopost_before_call(self, picking, payload):
        self._chronopost_manage_options(picking, payload)
        return payload

    def _get_chronopost_object_type(self, picking):
        # Override it to implement a specific logic
        return 'MAR'

    def _chronopost_get_parcel(self, picking):
        vals = self._roulier_get_parcel(picking)
        vals['objectType'] = self._get_chronopost_object_type(picking)
        # Manage options
    ...
    def _chronopost_should_include_customs(self, picking):
